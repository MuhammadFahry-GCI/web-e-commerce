    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-8 text-center">
            <div class="mb-6">
                ...
                <p class="text-gray-600">Terima kasih telah berbelanja di ElektroMart</p>
            </div>
            ...
            <div class="bg-blue-50 rounded-lg p-6 mb-6">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="font-bold text-blue-600 text-xl">Rp {{ number_format($order->total, 0, ',', '.') }}</span>
                </div>
            </div>
            ...
            <div class="mb-8">
                <div class="flex items-start gap-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-left">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Kami telah mengirimkan email konfirmasi pesanan ke <strong>{{ $order->shipping_email }}</strong>. Silakan cek inbox atau folder spam.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8 bg-orange-50 border border-orange-200 rounded-lg p-6 text-left">
                <h3 class="font-bold text-lg mb-3"><i class="fas fa-info-circle text-orange-600 mr-2"></i>Instruksi Pembayaran</h3>
                ...
                <p class="text-sm text-gray-600 mt-3">
                    Setelah transfer, konfirmasi melalui WhatsApp: <strong class="text-green-600">+62 812-3456-7890</strong>
                </p>
            </div>
            @elseif($order->payment_method === 'cod')
            <div class="mb-8 bg-green-50 border border-green-200 rounded-lg p-6">
                <h3 class="font-bold text-lg mb-2"><i class="fas fa-money-bill-wave text-green-600 mr-2"></i>Bayar di Tempat (COD)</h3>
                <p class="text-gray-700">Siapkan uang tunai sebesar:</p>
                <p class="text-2xl font-bold text-green-600 my-2">Rp {{ number_format($order->total, 0, ',', '.') }}</p>
            </div>
            @endif
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{{ route('products') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-6 py-3 rounded-lg font-semibold">
            ...
            <div class="mt-8 pt-6 border-t">
                ...
                <div class="flex justify-center gap-4">
                    <a href="https://wa.me/6281234567890" target="_blank" class="flex items-center gap-2 text-green-600 hover:text-green-700">
                    ...
                    <a href="mailto:info@elektromart.com" class="flex items-center gap-2 text-orange-600 hover:text-orange-700">
