        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex justify-between items-center py-4">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-2">
                    ...
                    <span class="text-2xl font-bold">ElektroMart</span>
                </a>
                ...
                <div class="flex items-center gap-4">
                    @auth
                        ...
                        <div class="relative" id="user-menu">
                            <button id="user-menu-button" class="flex items-center gap-2 hover:text-blue-200 focus:outline-none">
                                <i class="fas fa-user-circle text-2xl"></i>
                                <span class="hidden md:block">{{ Auth::user()->name }}</span>
                            </button>
                            <div id="user-dropdown" class="hidden absolute right-0 mt-2 w-48 bg-white text-gray-800 rounded-lg shadow-lg py-2 z-50 fade-enter">
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="bg-white text-blue-600 px-4 py-2 rounded hover:bg-gray-100">
                            Register
                        </a>
                    @endguest
                </div>
    ...
    <footer class="bg-gray-800 text-white mt-12">
        <div class="container mx-auto px-4 py-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="font-bold text-lg mb-4">ElektroMart</h3>
                    <p class="text-gray-400 text-sm">Toko alat elektronik terpercaya dengan produk berkualitas dan harga terjangkau.</p>
                </div>
                <div>
