        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4 group">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 leading-relaxed">Panam, Jl. HR. Soebrantas No.Km. 15<br>RW.15, Simpang Baru<br>Kota Pekanbaru, Riau 28293<br>Indonesia</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 group">
                        ...
                        <div>
                            ...
                            <a href="mailto:elyctravoid@gmail.com" class="text-gray-600 hover:text-orange-600 transition block">elyctravoid@gmail.com</a>
                    ...
                    <div class="flex items-start gap-4 group">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 leading-relaxed">Senin - Jumat: 09:00 - 18:00<br>Sabtu: 09:00 - 15:00<br>Minggu: Tutup</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-xl p-8 lg:p-10">
                ...
                <div class="space-y-4">
                    ...
                    <a href="https://www.instagram.com/elektromart.id?igsh=ZWRtdnE3a2Fvamti"
                    ...
                    <a href="https://twitter.com/elektromart"
                        class="flex items-center gap-4 p-6 border-2 border-gray-200 rounded-xl hover:border-blue-400 hover:bg-blue-50 hover:shadow-lg transition transform hover:-translate-y-1">
                        <div class="bg-blue-100 w-14 h-14 rounded-lg flex items-center justify-center flex-shrink-0">
                            <i class="fab fa-twitter text-3xl text-blue-400"></i>
                        </div>
                        <div>
                            <p class="font-bold text-gray-800 text-lg">Twitter</p>
                            <p class="text-sm text-gray-500">@elektromart</p>
                        </div>
                        <i class="fas fa-arrow-right ml-auto text-gray-400"></i>
                    </a>
