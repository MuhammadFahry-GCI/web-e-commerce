            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Panam, Jl. HR. Soebrantas No.Km. 15 <br>RW.15, Simpang Baru, Kota Pekanbaru, Riau 28293
                        ...
                        <div class="flex items-start gap-4">
                            <div
                                class="bg-orange-100 w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0">
                                <i class="fas fa-envelope text-orange-600 text-xl"></i>
                            </div>
                            <div>
                                <h3 class="font-semibold mb-1">Email</h3>
                                <p class="text-gray-600">elyctravoid@gmail.com<br>elyctravoid@gmail.com</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-4">
                            <div
                                class="bg-purple-100 w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0">
                                <i class="fas fa-clock text-purple-600 text-xl"></i>
                            </div>
                            <div>
                                <h3 class="font-semibold mb-1">Jam Operasional</h3>
                                <p class="text-gray-600">Senin - Jumat: 09:00 - 18:00<br>Sabtu: 09:00 - 15:00<br>Minggu:
                                    Tutup</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a href="https://www.facebook.com/share/19sDniTYkU/" class="flex items-center gap-3 p-4 border rounded-lg hover:bg-blue-50 transition">
                        ...
                        <a href="https://www.instagram.com/elektromart.id?igsh=ZWRtdnE3a2Fvamti" class="flex items-center gap-3 p-4 border rounded-lg hover:bg-pink-50 transition">
                        ...
                        <a href="https://wa.me/6281234567890" target="_blank"
                            class="flex items-center gap-3 p-4 border rounded-lg hover:bg-green-50 transition">
